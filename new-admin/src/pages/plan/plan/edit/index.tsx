...
import { useUpdatePlan } from "#src/store/plan.js";
...
export type ModalEditPlanProps = {
  isShowModal: boolean;
  formValue: Partial<IPlan>;
  setIsShowModal: (value: boolean) => void;
  onSuccess?: VoidFunction;
};

export function ModalEditPlan(props: ModalEditPlanProps) {
  ...
  const onFinish: FormProps<IPlan>["onFinish"] = async (values) => {
    try {
      ...
      const resp = await updatePlan(values);
      if (resp && resp.code !== 0) {
